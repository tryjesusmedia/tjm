    ...
    useEffect(() => {
      ...
      measureFrame = requestAnimationFrame(() => {
        readyFrame = requestAnimationFrame(() => {
          ...
          // Size the card's internal scrolling area without moving the camera.
          // Opening a principle and changing its text size must preserve the
          // zoom and pan position chosen by the user.
