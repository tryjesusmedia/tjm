(() => {
  ...
  function preferredStep() {
    ...
    if (saved !== null) return resolveStep(saved);
  ...
  function makeControls() {
    ...
    controls.innerHTML = `
      <span aria-live="polite" aria-atomic="true">Text size <output data-principles-text-status></output></span>
      <button type="button" data-principles-text-action="decrease" aria-label="Use smaller Principles text">A−</button>
      <button type="button" data-principles-text-action="reset" aria-label="Use standard Principles text" aria-pressed="false">A</button>
    ...
    controls.addEventListener("click", (event) => {
      ...
      if (button.dataset.principlesTextAction === "reset") applyStep(DEFAULT_STEP);
