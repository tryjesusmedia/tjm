...
document.write('<link rel="stylesheet" href="../lib/principles-text-size.css?v=20260910-2">');
...
document.write('<script type="module" src="../lib/principles-folders-flow.mjs?v=20260910-2"><\/script>');
