...
document.write('<link rel="stylesheet" href="../lib/principles-folders-flow.css?v=20260903-2">');
document.write('<script defer src="../lib/principles-react-flow-bridge.js?v=20260903-2"><\/script>');
document.write('<script type="module" src="../lib/principles-folders-flow.mjs?v=20260903-2"><\/script>');
