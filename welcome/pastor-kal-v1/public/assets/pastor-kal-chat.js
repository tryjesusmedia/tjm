(() => {
  ...
  launcher.innerHTML = '<span class="pk-launcher-dot" aria-hidden="true"><img src="/assets/pastor-kal-avatar.jpg" alt=""></span><span>Ask Pastor Kal</span>';
  ...
  avatar.innerHTML = '<img src="/assets/pastor-kal-avatar.jpg" alt="Pastor Kal">';
  ...
  footer.append(form, el("div", "pk-disclaimer", "Pastor Kal is an AI Bible guide, not the human pastor. For emergencies, contact local emergency services or a trusted person who can be with you."));
  ...
  function addMessage(role, text, { save = false, sources = [] } = {}) {
    ...
    if (sources.length) {
      body.append(el("div", "pk-sources", `Knowledge used: ${sources.join(", ")}`));
    }
    if (save) {
