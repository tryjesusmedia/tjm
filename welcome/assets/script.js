// Preserve signup conversion tracking when both pages share the same content.
if (window.location.pathname.replace(/\/$/, '') === '/signupcomplete') {
  ...
  window.fbq('init', '1819031611978353');
