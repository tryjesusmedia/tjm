...
assert.match(html, /Progress, highlights, and notes can be saved and synced after you sign in/);
...
assert.doesNotMatch(`${html}\n${app}\n${config}`, /principles-folders|TJMPrinciples|principleManager/);
...
console.log(`Chronological plan validated: ${plan.readings.length} named tasks, ${plan.chapterCount} individually trackable chapters, and native Bible reading across ${plan.sections.length} sections.`);
