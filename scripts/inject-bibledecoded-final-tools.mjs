...
lesson=lesson.replace('</head>','<link rel="stylesheet" href="/bibledecoded/assets/final-tools.css?v=3"><script defer src="/bibledecoded/assets/final-tools-v2.js?v=3"></script></head>');
