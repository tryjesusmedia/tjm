...
assert.match(source.conflictIndex, /config\.js\?v=20260909-3/);
...
assert.match(source.chronIndex, /config\.js\?v=20260909-3/);
...
for (const config of [source.conflictConfig, source.chronConfig]) {
  assert.match(config, /principles-text-size\.css\?v=20260909-2/);
  assert.match(config, /principles-text-size\.js\?v=20260909-2/);
}
